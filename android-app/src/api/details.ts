...
const DEFAULT_FIELDS = 'PrimaryImageAspectRatio,CanDelete,Overview,Studios,Genres,MediaSources,DateCreated,People,ProviderIds,SpecialEpisodeNumbers,Chapters,RemoteTrailers,LocalTrailers';
 ...
 * 获取指定剧集的下一集
 */
export async function getNextUpEpisode(userId: string, seriesId: string): Promise<BaseItemDto | null> {
